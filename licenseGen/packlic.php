...
if(genFootPrint()){  
  echo "FootPrint File created Successfully<br/>";
  if(file_exists("mansion.fpt")){
      ...
      if(! file_put_contents("../config/mansion.lic",$gzdata) ){
          echo "Error while creating the License File<br/>";        
      }else{
          echo "License File created Successfully<br/>";
      }
  }else{
    echo "Error: FootPrint file not found. Generate the FootPrint file first<br/>";
  }
}else{
  echo "Error while creating the FootPrint File<br/>";
}
?> 